---
title:  "Core Principles of Academic integrity"
description: "Dive into the core principles of academic integrity! Learn why honesty matters in education and how to maintain ethical standards in your academic work."
layout: post
...
* **Fabrication:** This is the act of *making up* data, sources, or results. If I haven't collected the data, I don't report it.
* **Misrepresentation:** This involves deceiving an instructor about my effort, such as submitting a paper written by someone else, or faking reasons for extensions.
...
* **Unauthorized Materials:** Using notes or electronic devices during a closed-book exam.
* **Collusion:** Working with a partner on an assignment specifically designated as individual **Original Work**.
* **Improper Resource Use:** Submitting a paper I purchased from a ghostwriting service or having an AI generate the core ideas without proper disclosure (which violates the **Student Code of Conduct**).
...
* **Understanding the Rules:** I read the syllabus and the **Student Code of Conduct** at the start of every semester. I don't plead ignorance if an issue arises.
* **Seeking Clarification:** If I am ever unsure whether an action constitutes **Cheating** or **Plagiarism** especially concerning complex collaborative projects or **Research Integrity** standards I ask the instructor *before* I submit the work.
* **Reporting Misconduct:** While difficult, part of my **Responsibility** as a member of the academic community is reporting observed violations of **Academic Integrity** by others, thus protecting the **Trust** and **Fairness** for all students.

I believe taking **Responsibility** is key to maintaining **Authenticity** in all facets of my academic life.

> Read too : [How to Use ai Ethically as a Student](https://bytehuman.blog/how-to-use-ai-ethically-as-a-student/)
...
* **The Five Pillars:** The **Core Principles** are **Honesty, Trust, Fairness, Respect, and Responsibility**.
* **Plagiarism Prevention:** Always use proper **Citation** and **Referencing** to demonstrate **Respect** for **Intellectual Property**.
* **Proactive Approach:** Read the **Student Code of Conduct** and ask instructors when unsure about the rules regarding group work or external sources.
* **Authenticity:** The goal of **Academic Integrity** is to ensure all work represents your **Original Work**.

## FAQ: Questions on **Academic Integrity** and **Academic Standards**

<details>
  <summary>What is the most concise definition of Academic Plagiarism?</summary>
  <p>Plagiarism is the act of **using another person's ideas, words, or works without proper acknowledgment** and presenting them as your own original creation. It is a fundamental breach of academic honesty, whether intentional or accidental.</p>
</details>

<details>
  <summary>What is the primary purpose of using a citation style (like APA or MLA)?</summary>
  <p>The primary purpose is to give the original author **credit for their intellectual work** (avoiding plagiarism) and to provide readers with the necessary information to **locate and verify** the sources you used to support your arguments.</p>
</details>

<details>
  <summary>What is a key difference between quoting and paraphrasing?</summary>
  <p>When **quoting**, you reproduce the author's exact words, placing them in quotation marks. When **paraphrasing**, you restate the author's ideas in your own words and sentence structure. Critically, **both** require proper referencing and a citation.</p>
</details>

<details>
  <summary>What is considered "Self-Plagiarism" and is it really a violation?</summary>
  <p>**Self-Plagiarism** occurs when you submit or reuse substantial portions of your own previously submitted or published work without proper citation or permission from the instructor/publisher. Yes, it is a violation of **Academic Integrity** because you are presenting old work as new effort.</p>
</details>

<details>
  <summary>When should I use a citation for a concept?</summary>
  <p>You must use a citation anytime you reference information that is **not common knowledge** (i.e., data, statistics, unique theories, or specific findings). If you had to look it up in a source, you must cite it.</p>
</details>